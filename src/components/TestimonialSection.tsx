...
const TestimonialSection = () => {
  const testimonials = [
    ...
    {
      id: 2,
      name: 'Sahasra Wanaparthi',
      role: 'BBA Student',
      university: 'Avinash College of Commerce',
      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-white/70 max-w-2xl mx-auto">
            See how students around the world are using StudyOrbit to advance their careers.
          </p>
        </div>
